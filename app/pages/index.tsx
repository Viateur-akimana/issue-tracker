...
const Home: React.FC = () => (
  <div className=" bg-purple-900 flex flex-col items-center justify-center">
    ...
    <footer className="text-white bg-black min-w-full   flex min-h-full text-sm text-center p-10">
      <div className='flex-start'>
        ...
        <div className="flex justify-center space-x-4">
          <p className="text-blue-500 hover:text-blue-700 transition-colors mb-4 block">
            Efficiency in Management
          </p>
        </div>
      </div>
      <div className="flex flex-col space-x-9 sm:flex-row sm:space-x-4 justify-center mb-4">
